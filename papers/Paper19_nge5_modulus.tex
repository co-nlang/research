...
$GQ(2,2)$, the finite geometry of the two-qubit Pauli group~\cite{SanigaPlanat,VeldkampTwoQubits}---and the question $\Nanti=6?$ becomes a finite, classical one, which we
