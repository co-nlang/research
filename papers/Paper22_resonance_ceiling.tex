...
\subsection{\texorpdfstring{$K_5/H^3$: the anticommutation rung}{K5/H3: the anticommutation rung}}
...
\subsection{\texorpdfstring{$K_4/H^2$: the Maslov rung}{K4/H2: the Maslov rung}}
...
\begin{theorem}[Truncation at \texorpdfstring{$H^3$}{H3}]\label{thm:trunc}
...
The ceiling is configuration-specific.  The Mermin--Peres magic
square~\cite{Mermin}, a standard object in the finite geometry of the two-qubit
Pauli group (the doily $\Sp(4,\F_2)\cong S_6$~\cite{SanigaPlanat,VeldkampTwoQubits}),
is, in our language, six Lagrangians in $\Sp(4,\F_2)$: three ``rows'' and three
``columns'',
\[
\begin{array}{ccc}
...
\bibitem[VeldkampTwoQubits]{VeldkampTwoQubits}
M. Saniga, M. Planat, P. Pracna, and H. Havlicek,
``The Veldkamp Space of Two-Qubits,''
\textit{SIGMA} \textbf{3} (2007), 075;
arXiv:0704.0495.
